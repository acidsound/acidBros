    ...
    */
    class RotaryKnob {
        constructor(container, label, id, min, max, value, step = 1) {
            this.min = min;
            this.max = max;
            this.value = value;
            this.step = step;
            ...
            // The CSS 'touch-action: none' on .rotary-knob prevents scrolling
        ...
        startDrag(e) {
            // Only prevent default if it is the knob being touched
    ...
    const Data = {
        ...
        exportState() {
            ...
            const state = {
                ...
                wave: document.getElementById('wave303').value,
                k: knobs, 
                s3: this.seq303, 
                s9: this.seq909 
            };
        ...
        importState(encoded) {
            try {
                ...
                document.getElementById('tempoVal').innerText = state.bpm + " BPM";
                document.getElementById('wave303').value = state.wave;
    ...
    const UI = {
        init() {
            ...
            document.getElementById('tempo').oninput = (e) => {
                ...
                document.getElementById('tempoVal').innerText = e.target.value + " BPM";
            };
