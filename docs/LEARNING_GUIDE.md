...
1. [Chapter 1: Getting Started](#chapter-1-getting-started) – Introduction and basic operation
2. [Chapter 2: Creating Rhythms](#chapter-2-creating-rhythms) – Using knobs and the sequencer
3. [Chapter 3: Shaping Sound](#chapter-3-shaping-sound) – Filter, envelope, and LFO
4. [Chapter 4: Multi-Track Production](#chapter-4-multi-track-production) – Using multiple channels
5. [Chapter 5: Saving and Sharing](#chapter-5-saving-and-sharing) – Managing patches and exporting
6. [Chapter 6: Advanced Techniques](#chapter-6-advanced-techniques) – MIDI and audio integration
...
*Made with ❤️ for the acid community*
